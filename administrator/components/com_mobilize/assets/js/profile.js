    ...
    function ($, JSNModal, JSNStyle, JSNMobilizeDialogEdition) {
        ...
        JSNMobilizeProfileView.prototype = {
            init:function () {
				...
				$(".mobilize-menu .link-menu-mobilize").each(function (){
					if($(this).attr('data-type') === 'mobilize-menu'){
						if($(this).attr("data-value") === ''){
							var url = "index.php?option=com_mobilize&view=menus&layout=menus&tmpl=component&jsnaction=update";
				...
				$('#slDevive').change(function (){
					var slD = $('#slDevive').val();
					if(slD === 'jsn_mobile'){
						$("#mobile_ui_enabled").click();	
						$('#mobilize-mobile-tool-left').css({'display':'none'});
						$('#mobilize-content-top-left').css({'display':'none'});
						$('#mobilize-user-top-left').css({'display':'none'});
						$('#mobilize-user-bottom-left').css({'display':'none'});
						$('#mobilize-content-bottom-left').css({'display':'none'});
						$('#mobilize-footer-left').css({'display':'none'});
					}
					if(slD === 'jsn_tablet'){
                ...
                if (load == "default") {
                    if (cookieView && $("#jform_profile_id").val()) {
                        if (cookieView == "tablet_ui_enabled") {
							document.getElementById('jsn_tablet').setAttribute('selected',true);
							document.getElementById('jsn_mobile').removeAttribute("selected");
							...
							document.getElementById('jsn_mobile').setAttribute('selected',true);
							document.getElementById('jsn_tablet').removeAttribute("selected");
