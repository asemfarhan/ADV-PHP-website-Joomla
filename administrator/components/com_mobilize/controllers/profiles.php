		...
		if($_FILES['fileupload']){
			...
			if(isset($_FILES["fileupload"]))
			{
				...
				else
				{
					...
					if(move_uploaded_file($_FILES["fileupload"]["tmp_name"],$output_dir. $_FILES["fileupload"]["name"])){
						if($_SERVER['SERVER_PORT'] !== ''){
							echo 'http://' . $_SERVER['SERVER_NAME'] .':'.$_SERVER['SERVER_PORT']. JURI::root(true) ."/uploads/" . $_FILES["fileupload"]["name"];die;
						}else{
							echo 'http://' . $_SERVER['SERVER_NAME'] . JURI::root(true) ."/uploads/" . $_FILES["fileupload"]["name"];die;
						}
					}
				}
			}
