...
class JSNMobilizeHelper {
	...
	if($key === 'jsn_template'){
        ...
        if (!empty($itemMobileToolSubTitle[$key])) {
            $codeCss[] = "#jsn-master .jsn-mobile-layout h1,#jsn-master .jsn-mobile-layout h2,#jsn-master .jsn-mobile-layout h3,#jsn-master .jsn-mobile-layout h4,#jsn-master .jsn-mobile-layout h5,#jsn-master .jsn-mobile-layout h6" . "{ " . implode("", $itemMobileToolSubTitle[$key]) . " }";
        }
        ...
        if (!empty($itemMobileToolSubTitle[$key])) {
            $codeCss[] = "#jsn-master .jsn-mobile-layout #" . str_replace("_", "-", $key) . " .contentheading{ " . implode("", $itemMobileToolSubTitle[$key]) . " }";
        }
        if (!empty($itemMobileToolSubLink[$key])) {
